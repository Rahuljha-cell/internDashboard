  ...
  return (
    <div>
      <style>{`
        ...
        <footer className="flex flex-col items-center justify-center w-full py-20 bg-gradient-to-b from-[#b72424ec] to-[#60190baf] text-white/70">
            <p className='text-lg'> <img className='w-15' src={logo} alt="" /> <a href="https://shecanfoundation.org/">She Can Foundation | Women's Empowerment & Careers 🌟</a></p>
            <p className="mt-4 text-center">Copyright © 2025 <a href="https://shecanfoundation.org/">She Can Foundation | Women's Empowerment & Careers 🌟</a>. All rights reservered.</p>
